...
namespace CollabBuy.CollabBuyApp.Models
{
    public class TransactionDetail
    {
        ...
        public int IdDetail
        {
            ...
            set
            {
                if (value <= 0) throw new ArgumentException("ID Detail tidak valid.");
                _idDetail = value;
            }
        }
        ...
        public string NamaPenitip
        {
            ...
            set
            {
                if (string.IsNullOrWhiteSpace(value))
                    throw new ArgumentException("Nama penitip wajib diisi.");
                _namaPenitip = value.Trim();
            }
        }
        ...
        public int JumlahPesanan
        {
            ...
            {
                if (value < 1)
                    throw new ArgumentException("Jumlah pesanan harus ≥ 1.");
